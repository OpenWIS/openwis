<%--
   ...
   $Id: org_inactive.jsp,v 1.5 2008/08/15 01:05:29 veiming Exp $
...
<%@page info="Organization Inactive" language="java"%>
...
<head>
<title><jato:text name="htmlTitle_OrgInactive" /></title>
          ...
          <tr>
            ...
            border="0" />
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                height="21" width="21" />
                <auth:resBundle bundleName="amAuthUI" resourceKey="orginactive" /> 
                </div>
