      ...
      <td class="LogCntTd" style="background-image: url(<%= ServiceURI %>/images/login-backimage.jpg);
        ...
        width="100%" title="">
          <tr>
            ...
            src="<%= ServiceURI %>/images/PrimaryProductName.png" alt="OpenSSO" 
            border="0" />
            ...
            by using auth 'value' tag with key 'RedirectURL' as
            <auth:value key="RedirectURL" />
            OR using public method from viewbean as
            viewBean.getDisplayFieldValue(REDIRECT_URL);
            -->
            </p>
            </tr>
            <tr>
