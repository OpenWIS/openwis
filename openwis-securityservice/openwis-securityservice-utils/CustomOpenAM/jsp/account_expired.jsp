<%--
   ...
   $Id: account_expired.jsp,v 1.5 2008/08/15 01:05:28 veiming Exp $
...
<%@page info="Account Expired" language="java"%>
...
<head>
<title><jato:text name="htmlTitle_AccountExpired" /></title>
          ...
          <tr>
            ...
            border="0" />
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                height="21" width="21" />
                <auth:resBundle bundleName="amAuthUI" resourceKey="account.expired" />                
                </div>
