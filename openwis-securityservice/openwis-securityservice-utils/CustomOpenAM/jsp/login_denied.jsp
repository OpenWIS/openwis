...
<%@page info="User has no profile in this organization" language="java"%>
...
<head>
<title><jato:text name="htmlTitle_UserProfileNotFound" /></title>
          ...
          <tr>
            ...
            border="0" />
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                height="21" width="21" />
                <auth:resBundle bundleName="amAuthUI" resourceKey="userhasnoprofile.org" />
                </div>
