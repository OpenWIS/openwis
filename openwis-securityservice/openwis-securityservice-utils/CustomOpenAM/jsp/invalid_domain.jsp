<%--
   ...
   $Id: invalid_domain.jsp,v 1.5 2008/08/15 01:05:29 veiming Exp $
...
<%@page info="Invalid Domain" language="java"%>
...
<head>
<title><jato:text name="htmlTitle_InvalidDomain" /></title>
          ...
          <tr>
            ...
            border="0" />
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                height="21" width="21" />
                <auth:resBundle bundleName="amAuthUI" resourceKey="nosuch.domain" />
                </div>
