...
<body class="LogBdy" style="background-color:none" onload="placeCursorOnFirstElm();">
  ...
  <table border="0" cellpadding="0" cellspacing="0" align="center" title="">
    ...
    <tr>
      <td class="LogMidBnd" style="background-image: url(<%= ServiceURI %>/images/gradlogsides.jpg);
        background-repeat:repeat-x;background-position:left top;background-color:none;">&nbsp;</td>
      <td class="LogCntTd" style="background-image: url(<%= ServiceURI %>/images/login-backimage.jpg);
        background-repeat:no-repeat;background-position:left top;" height="360" align="center" valign="middle">
        <table border="0" background="<%= ServiceURI %>/images/dot.gif" cellpadding="0" cellspacing="0" 
        width="100%" title="">
          <tr>
            <td width="260"><img src="<%= ServiceURI %>/images/dot.gif" width="260" height="150" alt="" /></td>
            <td width="415" bgcolor="#ffffff" valign="top"><img src="<%= ServiceURI %>/images/dot.gif" width="30" height="1" alt="" />
			<!--AAimg name="Login.productLogo" 
        ...
        <td><div class="logInp">
            <input type="text" name="IDToken<jato:text name="txtIndex" />"
                ...
                value="<jato:text name="txtValue"/>" class="TxtFld" size="12"></div>
        </td>
        </form>
        </tr>        
        <!-- end of textBox -->
        ...
        <td><div class="logInp">
            <input type="password" name="IDToken<jato:text name="txtIndex" />"
                id="IDToken<jato:text name="txtIndex"/>"
                value="" class="TxtFld" size="12" ></div>
        </td>
        </form>
        </tr>        
        <!-- end of password -->
    ...
    background-repeat:repeat-x;background-position:left top;">
      ...
      <td><!--div class="logCpy"><span class="logTxtCpy">
		...
		<img src="<%= ServiceURI %>/images/dot.gif" width="1" height="50" alt="" />    
      </td>
      <td>&nbsp;</td>
    </tr>
  </table>
