...
In a terminal, go into the root directory and launch the command: `mvn -Dresume=false release:prepare-Popenwis -Darguments="-DskipTests"` followed by a build of the admin portal
