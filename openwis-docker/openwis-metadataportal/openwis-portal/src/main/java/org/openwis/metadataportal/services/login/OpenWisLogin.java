...
public class OpenWisLogin implements Service {
   ...
   public Element exec(Element params, ServiceContext context) throws Exception {
      ...
      ServletContext servletContext = context.getJeevesServlet().getServletContext();
...
//         userSessionManager.registerUser(context.getUserSession().getUsername());
         ...
         userSessionManager.unregisterUser(context.getUserSession().getUsername());
