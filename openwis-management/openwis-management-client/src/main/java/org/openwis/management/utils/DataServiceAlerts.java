...
public enum DataServiceAlerts {
	/**
	 * The threshold for the maximum size of transferred bytes via the chosen dissemination threshold has been exceeded.
	 */
	DISSEMINATION_THRESHOLD_EXCEEDED ("dataservice.disseminationThresholdExceeded"),
...
//   CRITICAL_DATA_RECEIVED ("dataservice.criticalDataReceived"),
   ...
   /**
    * Notifies the arrival of a file with an unparsable name.
    */
   UNPARSABLE_FILE ("dataservice.unparsableFile"),
   ...
   /**
    * Failure to process event subscription. <br>
    */
   SUBCRIPTION_EVENT_ALERT("dataservice.subscription.event.fails"),

   /**
    * Failure to process recurrent subscription. <br>
    */
   SUBCRIPTION_TIMER_ALERT("dataservice.subscription.recurrent.fails"),
...
# </ol>
   ...
   STOPGAP_METADATA_CREATED("dataservice.stopgapMetadataCreated"),
	...
	# </ol>
	    */
	   MAX_RESEEDS_EXCEEDED("dataservice.maxReseedsExceeded");
