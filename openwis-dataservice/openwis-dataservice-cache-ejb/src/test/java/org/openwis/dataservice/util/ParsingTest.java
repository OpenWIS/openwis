...
public class ParsingTest {
	...
	public final String[] filenames = {
			"A_YMIU46LFPW300600_C_LFPW_------300600--.bin"
			// GTS					
...
//			,"W_NL-KNMI-DeBilt,ASCAT,ears+metopa+sva_C_EHDB_20090819074022_ascat_20090819_074022_metopa_14699_ear_o_125_ovw_l2_bufr.bin"
	...
	public void parseTest(){		
		for (String filename : filenames){
			WMOFNC wmofnc = GlobalDataCollectionUtils.parseFileName(filename);
			System.out.println("---");
			System.out.println("Filename: " + filename);
			System.out.println("Parsed Filename: " + wmofnc.toString());
			System.out.println("HasAllMandatoryFields: " + wmofnc.hasAllMandatoryFields());
			System.out.println("MandatoryFields: " + Arrays.toString(wmofnc.getMandatoryFields()));
			System.out.println("HasNonMandatoryFields: " + wmofnc.hasNonMandatoryFields());
			System.out.println("NonMandatoryFields: " + Arrays.toString(wmofnc.getNonMandatoryFields()));
			System.out.println("ProductDate: " + wmofnc.getProductDate());
			System.out.println("Metadata: " + wmofnc.getMetadata());
			System.out.println("MetadataURN: " + wmofnc.getMetadataURN());
			System.out.println("---");
			assertEquals(filename,wmofnc.toString());
		}
	}
}