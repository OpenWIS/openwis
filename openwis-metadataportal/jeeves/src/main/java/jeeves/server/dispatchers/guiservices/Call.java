...
public class Call implements GuiService, ServiceWithJsp
{
	private String  name;
   ...
   public Call(Element config, String pack, String appPath) throws Exception
	...
	public Map<String, Object> execWithJsp(Element params, ServiceContext context) throws Exception {
	   try
      {
	      ServiceWithJsp serviceWithJsp = (ServiceWithJsp) serviceObj;
	      Map<String, Object> response = serviceWithJsp.execWithJsp(params, context);
