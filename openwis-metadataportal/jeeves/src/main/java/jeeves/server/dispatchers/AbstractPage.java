...
public abstract class AbstractPage {
   ...
   public boolean isJsp() { return getStyleSheet() != null && getStyleSheet().endsWith(".jsp"); }
   ...
   public Element invokeGuiServices(ServiceContext context, Element response,
         List<GuiService> defaults) {
   ...
   public Map<String, Object> invokeGuiServicesWithJsp(ServiceContext context, Element response) {
      ...
      for (GuiService guiSrv : vGuiServ) {
         try {
            if (guiSrv instanceof ServiceWithJsp) {
               Map<String, Object> m = ((ServiceWithJsp) guiSrv).execWithJsp(response, context);
               attrMap.putAll(m);
            }
         } catch (Exception e) {
            ServiceManager.error("Exception executing gui jsp service : " + e.toString());
   ...
   private void invokeGuiService(ServiceContext context, Element response, Element root,
         List<GuiService> guiServices) {
