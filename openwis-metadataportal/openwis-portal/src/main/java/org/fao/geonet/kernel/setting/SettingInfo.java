...
public class SettingInfo
{
	...
	public boolean getIndexOptimizerSchedulerEnabled()
	{
      return "true".equals(sm.getValue("system/indexoptimizer/enable"));
	}
	...
	{
      return "true".equals(sm.getValue("system/xlinkResolver/enable"));
	}

	//---------------------------------------------------------------------------

	public Calendar getIndexOptimizerSchedulerAt() throws IllegalArgumentException {
	...
	public int getIndexOptimizerSchedulerInterval() throws IllegalArgumentException {
		int result = -1;
		try {
