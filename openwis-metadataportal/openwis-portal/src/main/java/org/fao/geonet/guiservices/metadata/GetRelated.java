...
public class GetRelated implements Service {
   ...
   public Element exec(Element params, ServiceContext context) throws Exception {
      ...
      if (uuid == null)
         throw new Exception("Could not retrieve UUID from geonet:info element provided.");
   ...
   private Element search(String uuid, String type, ServiceContext context) throws Exception {
