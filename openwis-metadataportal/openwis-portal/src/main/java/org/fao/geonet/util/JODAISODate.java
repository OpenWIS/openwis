...
public class JODAISODate
{
   ...
   /*
    * Converts a given ISO date time into the form used to index in index
   ...
   /*
    * Converts two ISO date times into standard form used to index
    * Always returns something because it is used during the indexing of the
    * metadata record in index - if exception during parsing then it is
