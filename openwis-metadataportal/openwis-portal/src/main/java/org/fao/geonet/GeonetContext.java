...
public class GeonetContext {
   ...
   /* package */ISearchManager searchMan;
   ...
   public ServiceConfig getHandlerConfig() {
      return config;
   }

   public CatalogDispatcher getCatalogDispatcher() {
      return catalogDis;
   }
   ...
   public OaiPmhDispatcher getOaipmhDispatcher() {
      return oaipmhDis;
   }
   ...
   public String getSiteName() {
      return settingMan.getValue("system/site/name");
   }
}
