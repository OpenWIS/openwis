...
public class MassiveOpsMetadataReindexer extends MetadataIndexerProcessor {
   ...
   public MassiveOpsMetadataReindexer(DataManager dm, Dbms dbms, Map<Integer, String> metadata) {
      super(dm);
      this.dbms = dbms;
   ...
   public void process() throws Exception {
      for (Entry<Integer, String> entry : metadata.entrySet()) {
         dm.indexMetadataGroup(dbms, entry.getValue(), null);
      }
   }
}
