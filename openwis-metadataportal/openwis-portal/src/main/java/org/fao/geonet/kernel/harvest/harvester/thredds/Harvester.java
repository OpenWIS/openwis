...
class Harvester
{
   ...
   static private final Namespace difNS = Namespace
         .getNamespace("http://gcmd.gsfc.nasa.gov/Aboutus/xml/dif/");
   ...
   static private final Namespace gmd = Namespace.getNamespace("gmd",
         "http://www.isotc211.org/2005/gmd");

   static private final Namespace srv = Namespace.getNamespace("srv",
    ...
    * @param uuid		the uuid of the metadata being saved
	...
	private void saveMetadata(Element md, String uuid) throws Exception {
		...
		String id = dataMan.insertMetadataExt(dbms, schema, md, params.uuid,
		        df.format(date), df.format(date), uuid, null);
