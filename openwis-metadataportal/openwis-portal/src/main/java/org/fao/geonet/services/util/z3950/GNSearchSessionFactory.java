...
public class GNSearchSessionFactory extends SearchSessionFactoryImpl {
   ...
   /**
    * {@inheritDoc}
    * @see org.jzkit.search.impl.SearchSessionFactoryImpl#setApplicationContext(org.springframework.context.ApplicationContext)
    */
   @Override
   ...
   /**
    * {@inheritDoc}
    * @see org.jzkit.search.impl.SearchSessionFactoryImpl#explain()
    */
   @Override
         ...
         */
         ...
         while (it.hasNext()) {
            ...
            for (String key : cw.getMappings().keySet()) {
               ...
               String attrString = attrmaping.getTargetAttrs().iterator().next()
                     .getWithDefaultNamespace("geo");
