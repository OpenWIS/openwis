...
public class Set implements Service {
   ...
   public Element exec(Element params, ServiceContext context) throws Exception {
      ...
      if (createSmall) {
         ...
         dataMan.setThumbnail(dbms, id, uuid, true, smallFile);
      }
      ...
      if (scaling) {
         ...
         dataMan.setThumbnail(dbms, id, uuid, type.equals("small"), newFile);
      } else {
         ...
         dataMan.setThumbnail(dbms, id, uuid, type.equals("small"), file);
      }
   ...
   // FIXME : not elegant
   public Element execOnHarvest(Element params, ServiceContext context, Dbms dbms,
   ...
   private void removeOldThumbnail(ServiceContext context, String id, String type) throws Exception {
      ...
      //--- remove thumbnail
      String uuid = dataMan.getMetadataUuid(dbms, id);
      dataMan.unsetThumbnail(dbms, id, uuid, type.equals("small"));
   ...
   private String getFileName(String file, boolean small) {
      ...
      return small ? file + SMALL_SUFFIX + "." + IMAGE_TYPE : file + "." + IMAGE_TYPE;
   }
