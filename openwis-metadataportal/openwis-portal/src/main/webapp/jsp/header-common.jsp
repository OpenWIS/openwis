...
%>
	...
	<meta name="description" content="This portal provides operational information and products on the weather" />
	<title><%= title %></title>
...
%>  
	...
	<script type="text/javascript" src="<%= context.getBaseUrl() %>/scripts/openlayers/OpenLayers.js"></script>
