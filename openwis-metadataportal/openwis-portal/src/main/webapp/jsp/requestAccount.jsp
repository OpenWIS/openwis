...
<html lang="en">
	...
	<body>
		<div class="main-content">
			...
			%>
			<p>Please fill in the following form in order to request an account.  All fields are required.</p>
			<!--  <form action="<%= context.getBaseUrl() %>/srv/en/user.accountRequest.submit" method="post">  -->
			<form action="<%= context.getBaseUrl() %>/openWisRequestAccount" method="post">
				<div>
					<label for="firstname">First Name:</label>					
					<input name="firstname" id="firstname" type="text" required="required" data-validation="required"/>
				</div>		
				<div>
					<label for="lastname">Last Name:</label>
					<input name="lastname" id="lastname" type="text" required="required" data-validation="required"/>
				</div>		
				...
				<div>
					...
					<input name="organisation" id="organisation" type="text" required="required" data-validation="required"/>
				</div>
				<div>
					<label for="country">Country:</label>
					<select name="country" id="country" data-validation="required">
						<!-- List taken from ISO-3166-1. -->
						<option value="" selected="selected">(Please select)</option>
						<option value="XI">International Organisation (e.g. WMO)</option>
