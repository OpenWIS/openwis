...
//        FIXME MultiSelect does not take care about template anymore...
//        // FIXME Add Ext.isIE8 ?
//        var divClass = (Ext.isIE || Ext.isIE7) ? '" unselectable=on':' x-unselectable"';
//        
//        var tpl = new Ext.Template(
//    		'<div class="ux-mselect-item'+divClass+'>{id} {value} ',
...
//    	);
        ...
        this.itemSelector = new Ext.ux.ItemSelector({
            ...
            drawTopIcon: false,
            drawBotIcon: false,
            imagePath: '/scripts/ext-ux/MultiselectItemSelector-3.0/icons',
            toTBar:[{
