...
{
	//preparePresent();
	var params = 'from=' + frompage + "&to=" + topage;
...
*
********************************************************************/
function gn_showSingleMetadataUUID(uuid,title)
{
   var pars = {uuid:uuid,currTab:'simple'};
   gn_showSingleMet(pars,title);
}

function gn_showSingleMetadata(id, title)
{
   gn_showSingleMet({id:id,currTab:'simple'}, title);
}

function gn_showSingleMet(pars, title)
{
    var showEl = $('gn_showmd_' + pars.id);
    ...
    if(!metadataWindow) {
        Ext.Ajax.request({
            url: getGNServiceURL('metadata.show.embedded'),
            params: pars,
            method:"GET",
...
function gn_showMetadata(id,title) {
	gn_showMetadataTab(id, 'simple',title);
}


var metadataWindow;

function gn_showMetadataTab(id, currTab,title)
{
    gn_showSingleMet({id:id,currTab:currTab},title)
}
