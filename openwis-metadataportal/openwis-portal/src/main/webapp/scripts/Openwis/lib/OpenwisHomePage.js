...
(function() {
     ...
     */
    window.OpenwisScriptsHelperHomePage = {
        
        /**
         * Property: _scriptName
         * {String} Relative path of this script.
         */
        _scriptName: "lib/OpenwisHomePage.js",
        ...
        _getScriptLocation: function () {
            var scriptLocation = "";            
            var isOL = new RegExp("(^|(.*?\\/))(" + OpenwisScriptsHelperHomePage._scriptName + ")(\\?|$)");
    ...
    if(!singleFile) {
        var jsfiles = new Array(
            ...
            // Include start page
            "Openwis/HomePage/Search/StartSearchPanel.js",
            "Openwis/HomePage/Search/StartRemoteSearchPanel.js",
        ...
        var host = OpenwisScriptsHelperHomePage._getScriptLocation() + "lib/";   
