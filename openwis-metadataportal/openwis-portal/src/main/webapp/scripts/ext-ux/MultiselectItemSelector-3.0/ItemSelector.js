 ...
 * added fromAllowDup, toAllowDup, fromAllowTrash
 */
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		this.fromMultiselect = new Ext.ux.Multiselect({
			...
			allowDup: this.fromAllowDup,
			copy: this.fromAllowDup,
			allowTrash: this.fromAllowTrash,
