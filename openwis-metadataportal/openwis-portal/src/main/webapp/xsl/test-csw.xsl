			...
			<body onload="init();">
				<div class="test-head">
						...
						<table width="100%" cellspacing="0">
							...
							<tr id="banner-logo">
								<td align="left" width="20%">
									<img src="../../images/openwis/header-left.jpg" alt="World picture" align="top" /> 
								</td>
								<td align="center" width="60%">
									<img src="../../images/openwis/titre_site.png" alt="World picture" align="top" />
								</td>
								<td align="right" width="20%">
									<img src="../../images/openwis/header-right.gif" alt="GeoNetwork opensource logo" align="top" />
								</td>
							</tr>
						</table>
						<br/>
					...
					<div class="test-head-text">
						...
						<p>
							Example requests for GeoNetwork opensource. Select a request from the
							drop down list, and then hit 'Change'. This will display the
							request url
				...
				<div class="test">
					...
					<select id="request" onchange="updateOperation(this);">
					</select>
					<br />
				...
				<div class="test-submit">
					...
					<input type="button" onclick="loginAndRun();" name="submit" value="Log in and send request (POST)" alt="Use this option to test transaction operation."
				...
				<div class="test-head-text">
					...
					<p>
						<ul>
							<li>
								<a href="csw?SERVICE=CSW&amp;VERSION=2.0.2&amp;REQUEST=GetCapabilities">GetCapabilities</a>
							</li>
							<li>
								<a href="csw?SERVICE=CSW&amp;VERSION=2.0.2&amp;REQUEST=GetRecordById&amp;ID=8c74e8c4-701a-4cd1-a988-7f2bf9e891bd">GetRecordById</a>
							</li>
						</ul>
					</p>
				</div>
