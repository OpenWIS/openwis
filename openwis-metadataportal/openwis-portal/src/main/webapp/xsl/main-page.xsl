...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template mode="css" match="/">
        ...
        <link rel="stylesheet" type="text/css" href="{/root/gui/url}/css/geonetwork_map.css" />
        
		<link rel="stylesheet" type="text/css" href="{/root/gui/url}/scripts/ext-ux/css/MultiSelect.css"/> 
		...
		<xsl:if test="/root/gui/config/search/keyword-selection-panel">
         ...
         <xsl:choose>
            <xsl:when test="/root/request/debug">         	
                ...
                <script type="text/javascript" src="{/root/gui/url}/scripts/ext-ux/FileUploadField.js"></script>
            	...
            	<!-- OpenWIS -->
            	<script type="text/javascript" src="{/root/gui/url}/scripts/ext-ux/FieldLabeler.js"></script> 
    			<script type="text/javascript" src="{/root/gui/url}/scripts/ext-ux/MultiSelect.js"></script> 
            	
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Utils/Array.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Utils/Date.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Utils/Tooltip.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Utils/MessageBox.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Utils/Override.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Handler/Save.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Handler/Remove.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Handler/Get.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Handler/Index.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Lang/Lang.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Data/JeevesJsonResponseHandler.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Data/JeevesJsonReader.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Data/JeevesJsonStore.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Data/JeevesJsonSubmit.js"></script>
		        <script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Data/JeevesJsonTreeLoader.js"></script>
            	
            	
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Lang/Locales/{/root/gui/language}.js"></script>
				
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Common/Dissemination/MailDiffusion.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Common/Dissemination/FTPDiffusion.js"></script>
            	
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/Helper/Matcher.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/Helper/MockSSPanel.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/Helper/SSPCatalog.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/Helper/SSPToExt.js"></script>
            	
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/GeographicalSelection/GeographicalExtent.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/ScheduleSelection/Schedule.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/PeriodSelection/Day.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/PeriodSelection/DateInterval.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/PeriodSelection/TimeInterval.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/MultipleSelection/Checkbox.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/MultipleSelection/ListBox.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/SingleSelection/Radio.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/SingleSelection/ComboBox.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/SingleSelection/ListBox.js"></script>
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/SourceSelection/Source.js"></script>
            	
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/SubSelectionParameters/SSPStandardProduct.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/DisseminationParameters/Components/Diffusion.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/DisseminationParameters/Components/MSSFSS.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/DisseminationParameters/Components/StagingPost.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/DisseminationParameters/Selection.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/Acknowledgement/Acknowledgement.js"></script>
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/RequestSubscription/Wizard.js"></script>
            	
            	<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/HomePage/LastProducts.js"></script>
            ...
            <xsl:otherwise>             
				...
				<script type="text/javascript" src="{/root/gui/url}/scripts/Openwis/Openwis.js"></script>
            </xsl:otherwise>
         </xsl:choose>
			   ...
			   var viewport = new Ext.Panel({
					...
					items:[
						...
						// Center: Content
						{
							...
							items:[
							{
								id:'center-content-first',
								region:'center',   
								border:false,
								layout: 'border',
								items:[
								{
									id:'west-panel-second',
									region:'west',
									xtype: 'panel',
									border:false,
									width: 370,
						...
						// FIXME due to duplicate style in CSS, CBS context :(
						$('main-panel').style.display = 'none';
						
						// OpenWIS last products
                        configOptions.locService = "<xsl:value-of select="/root/gui/locService"/>";
                        //doLastProducts(configOptions);
	...
	<xsl:template name="latestUpdates">
		<xsl:if test="/root/gui/latestUpdated/*">
			...
			<br />
			<!--
			<div id="lastProducts" class="geosearchfields">
				<div class="titre_bloc">My Last Products</div>
				<div class="fin_titre_bloc"></div>
				...
				<div id="fond-carte-bas"></div>
			</div>
			-->
			<div class="geosearchfields">
				<!-- FIXME loc strings -->
				<div class="titre_bloc">What's New ?</div>
				<div class="fin_titre_bloc"></div>
