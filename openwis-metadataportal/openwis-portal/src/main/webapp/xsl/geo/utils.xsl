...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    * GeoNetwork specific JS
    ...
    <xsl:template name="geoHeader">
        ...
        <xsl:choose>
            <xsl:when test="/root/request/debug">
                ...
                <script type="text/javascript" src="../../scripts/ext-ux/FileUploadField.js" />
            ...
            <xsl:otherwise>     
                ...
                <script type="text/javascript" src="{/root/gui/url}/scripts/lib/ext.libs.js"></script>
    ...
    <xsl:template name="ext-ux-css">
        <link rel="stylesheet" type="text/css" href="../../scripts/ext-ux/css/MultiSelect.css" />
        <link rel="stylesheet" type="text/css" href="{/root/gui/url}/scripts/ext-ux/css/fileuploadfield.css" />
    </xsl:template>
    
    <xsl:template name="ext-ux">    	
    	<script type="text/javascript" src="../../scripts/ext-ux/MultiSelect.js"></script>
        <script type="text/javascript" src="../../scripts/ext-ux/MultiselectItemSelector-3.0/ItemSelector.js"></script>
