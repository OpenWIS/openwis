...
import org.fao.oaipmh.configuration.OaipmhConfig;
import org.fao.oaipmh.configuration.OaipmhConfigurationConstants;
...
public abstract class AbstractRequest
{
																						  ...
																						  JDOMException, SAXException, Exception
	{
      ...
      boolean validate = OaipmhConfig
            .getBoolean(OaipmhConfigurationConstants.OAIPMH_VALIDATE_RESPONSE);
      
      //--- validate the result
      if (validate) {
         Xml.validate(response, schemaPath);
      }
